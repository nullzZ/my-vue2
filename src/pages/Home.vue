	...
	<div class="home">
		<div class="banner">
			 <swiper :options="swiperOption" class="swiper-box" >
					...
					<swiper-slide class="swiper-item" v-for="swiper in swipers">
						<img :src="swiper" alt="...">
					</swiper-slide>
...
export default {
	...
	data() {
		return {
			...
			swipers: ['http://ac-afkydcqq.clouddn.com/f7a0443a710ceded28ef.jpg','http://ac-afkydcqq.clouddn.com/f7a0443a710ceded28ef.jpg']
		}
	},
	created() {
